...
obj_5 = wol.Notebook.NotebookNode(parent=context.scene,name="Notebook10")
obj_5.position = PyQt5.QtGui.QVector3D(-7.534154891967773, 4.702805995941162, 9.65072250366211)
obj_5.orientation = PyQt5.QtGui.QQuaternion(0.7804508805274963, 0.16404679417610168, 0.6029054522514343, -0.022137926891446114)
obj_5.scale = PyQt5.QtGui.QVector3D(1.0, 1.0, 1.0)
obj_5.properties = {}
obj_5.visible = True
cell = obj_5.add_cell(0)
cell.set_text('scene.add_child(wol.CudaMemoryNode.CudaMemoryNode())')
cell = obj_5.add_cell(1)
cell.set_text('import wol\n')
cell = obj_5.add_cell(2)
cell.set_text('print()')
cell = obj_5.add_cell(3)
cell.set_text('')
cell = obj_5.layout()

obj_6 = wol.CudaMemoryNode.CudaMemoryNode(parent=context.scene,name="Card")
obj_6.position = PyQt5.QtGui.QVector3D(3.0, 3.0, 0.0)
...
obj_7.position = PyQt5.QtGui.QVector3D(3.0, 3.0, 2.0)
obj_7.orientation = PyQt5.QtGui.QQuaternion(1.0, 0.0, 0.0, 0.0)
obj_7.scale = PyQt5.QtGui.QVector3D(1.0, 1.0, 1.0)
obj_7.properties = {}
obj_7.visible = True

obj_8 = wol.CudaMemoryNode.CudaMemoryNode(parent=context.scene,name="Card")
obj_8.position = PyQt5.QtGui.QVector3D(3.0, 3.0, 4.0)
obj_8.orientation = PyQt5.QtGui.QQuaternion(1.0, 0.0, 0.0, 0.0)
obj_8.scale = PyQt5.QtGui.QVector3D(1.0, 1.0, 1.0)
obj_8.properties = {}
obj_8.visible = True

obj_9 = wol.CudaMemoryNode.CudaMemoryNode(parent=context.scene,name="Card")
obj_9.position = PyQt5.QtGui.QVector3D(0.0, 2.0, 0.0)
...
obj_11.position = PyQt5.QtGui.QVector3D(3.0, 3.0, 0.0)
...
obj_12.position = PyQt5.QtGui.QVector3D(3.0, 3.0, 2.0)
obj_12.orientation = PyQt5.QtGui.QQuaternion(1.0, 0.0, 0.0, 0.0)
obj_12.scale = PyQt5.QtGui.QVector3D(1.0, 1.0, 1.0)
obj_12.properties = {}
obj_12.visible = True

obj_13 = wol.CudaMemoryNode.CudaMemoryNode(parent=context.scene,name="Card")
obj_13.position = PyQt5.QtGui.QVector3D(3.0, 3.0, 4.0)
obj_13.orientation = PyQt5.QtGui.QQuaternion(1.0, 0.0, 0.0, 0.0)
...
obj_17 = wol.Notebook.NotebookNode(parent=context.scene,name="Notebook9")
obj_17.position = PyQt5.QtGui.QVector3D(-3.6063461303710938, 7.003222465515137, 0.8434467315673828)
obj_17.orientation = PyQt5.QtGui.QQuaternion(0.9906780123710632, 0.03617260977625847, -0.13099198043346405, -0.009470238350331783)
obj_17.scale = PyQt5.QtGui.QVector3D(1.0, 1.0, 1.0)
obj_17.properties = {}
obj_17.visible = True
cell = obj_17.add_cell(0)
cell.set_text('import torch\nimport torch.nn as nn\nimport torch.optim as optim\nimport torch.nn.functional as F\nfrom torch.utils.data import DataLoader\nimport torchvision.transforms as transforms\nimport torchvision.datasets as datasets\nimport time')
cell = obj_17.add_cell(1)
...
cell = obj_17.add_cell(5)
cell.set_text('\n\nimport wol\n\ncm=wol.CudaMemoryNode.CudaMemoryNode()')
cell = obj_17.add_cell(6)
cell.set_text('scene.add_child(cm)')
cell = obj_17.add_cell(7)
cell.set_text('cm.associate_tensor(model.probe)\n#cm.associate_tensor(model.fc3.weight)')
cell = obj_17.add_cell(8)
cell.set_text('cm.position = QVector3D(0, 2, 0)')
cell = obj_17.add_cell(9)
cell.set_text('print(12)')
cell = obj_17.add_cell(10)
cell.set_text('for model. ')
cell = obj_17.add_cell(11)
cell.set_text('')
cell = obj_17.layout()

obj_18 = wol.CudaMemoryNode.CudaMemoryNode(parent=context.scene,name="Card")
obj_18.position = PyQt5.QtGui.QVector3D(0.0, 2.0, 0.0)
obj_18.orientation = PyQt5.QtGui.QQuaternion(1.0, 0.0, 0.0, 0.0)
obj_18.scale = PyQt5.QtGui.QVector3D(1.0, 1.0, 1.0)
obj_18.properties = {}
obj_18.visible = True

obj_19 = wol.CudaMemoryNode.CudaMemoryNode(parent=context.scene,name="Card")
obj_19.position = PyQt5.QtGui.QVector3D(3.0, 3.0, 0.0)
obj_19.orientation = PyQt5.QtGui.QQuaternion(1.0, 0.0, 0.0, 0.0)
obj_19.scale = PyQt5.QtGui.QVector3D(1.0, 1.0, 1.0)
obj_19.properties = {}
obj_19.visible = True

obj_20 = wol.CudaMemoryNode.CudaMemoryNode(parent=context.scene,name="Card")
obj_20.position = PyQt5.QtGui.QVector3D(3.0, 3.0, 2.0)
obj_20.orientation = PyQt5.QtGui.QQuaternion(1.0, 0.0, 0.0, 0.0)
obj_20.scale = PyQt5.QtGui.QVector3D(1.0, 1.0, 1.0)
obj_20.properties = {}
obj_20.visible = True

obj_21 = wol.CudaMemoryNode.CudaMemoryNode(parent=context.scene,name="Card")
obj_21.position = PyQt5.QtGui.QVector3D(3.0, 3.0, 4.0)
obj_21.orientation = PyQt5.QtGui.QQuaternion(1.0, 0.0, 0.0, 0.0)
obj_21.scale = PyQt5.QtGui.QVector3D(1.0, 1.0, 1.0)
obj_21.properties = {}
obj_21.visible = True

obj_22 = wol.Notebook.NotebookNode(parent=context.scene,name="Notebook22")
obj_22.position = PyQt5.QtGui.QVector3D(-5.116328716278076, 2.9871015548706055, 3.194517135620117)
obj_22.orientation = PyQt5.QtGui.QQuaternion(0.9786635637283325, -0.13681286573410034, 0.15229035913944244, -0.017536628991365433)
obj_22.scale = PyQt5.QtGui.QVector3D(1.0, 1.0, 1.0)
obj_22.properties = {}
obj_22.visible = True
cell = obj_22.add_cell(0)
cell.set_text('import wol.CudaMemoryNode as cmn')
cell = obj_22.add_cell(1)
cell.set_text('for i,p in enumerate(context.model.parameters()):\n\tprint(p.shape)\n\tif(len(p.shape))==1:\n\t\tcontinue\n\tcm=cmn.CudaMemoryNode()\n\tscene.add_child(cm)\n\tcm.associate_tensor(p)\n\tcm.weights_scale = 20.0\n\tcm.position=QVector3D(3, 3, i)')
cell = obj_22.add_cell(2)
cell.set_text('for c in scene.children:\n\tprint(c.name, type(c))')
cell = obj_22.add_cell(3)
cell.set_text('')
cell = obj_22.layout()
